...
<div x-show="isBackupModal" 
    ...
    <div x-show="isBackupModal"
        ...
        <div class="px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-4 sm:pb-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            ...
            <button @click="isBackupModal = false"
        ...
        <div class="p-4 sm:p-6 lg:p-8" x-data="{ 
            ...
            backupDatabase() {
                if (!this.isBackingUp) {
                    ...
                    // Aquí se puede agregar la lógica para hacer backup de la base de datos
                    console.log('Haciendo backup de la base de datos...');
                    // TODO: Implementar la lógica de backup
                    // Simular proceso de backup (remover esto cuando se implemente la lógica real)
                    setTimeout(() => {
            ...
            exportExcel() {
                if (!this.isExporting) {
                    ...
                    // Aquí se puede agregar la lógica para exportar a Excel
                    console.log('Exportando a Excel...');
                    // TODO: Implementar la lógica de exportación
                    // Simular proceso de exportación (remover esto cuando se implemente la lógica real)
                    setTimeout(() => {
            ...
            <ol class="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4 md:mb-5">
                ...
                <li class="mb-10 ms-8">
                    ...
                    <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">
                        Última copia
                        <span id="ultima-copia-fecha">21 de noviembre del 2025 a las 2:17</span>
                    </time>
                    <button type="button"
                        @click="backupDatabase()"
                        :disabled="isBackingUp"
                        class="py-2 px-3 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 disabled:opacity-75 disabled:cursor-not-allowed transition-colors">
                        <template x-if="isBackingUp">
                            <svg class="animate-spin h-4 w-4 me-1.5 text-gray-900 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        <span x-text="isBackingUp ? 'Haciendo backup...' : 'Backup'"></span>
                    </button>
                </li>
                ...
                <li class="mb-4 ms-8">
                    ...
                    <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">
                        Última exportación
                        <span id="ultima-exportacion-fecha">21 de noviembre del 2025 a las 2:18</span>
                    </time>
                    <button type="button"
                        @click="exportExcel()"
    ...
    <div x-show="isBackupModal"
        ...
        <div class="flex justify-center pt-3 pb-2 py-4">
            <div class="w-12 h-1 bg-gray-300 dark:bg-gray-600 rounded-full cursor-pointer" @click.stop="isBackupModal = false"></div>
        </div>
        ...
        <div x-show="isBackupModal"
            ...
            <ol class="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4">
                ...
                <li class="mb-10 ms-8">
                    ...
                    <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">
                        Última copia
                        <span id="ultima-copia-fecha-mobile">21 de noviembre del 2025 a las 2:17</span>
                    </time>
                    <button type="button"
                        @click="backupDatabase()"
                        :disabled="isBackingUp"
                ...
                <li class="mb-4 ms-8">
                    ...
                    <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">
                        Última exportación
                        <span id="ultima-exportacion-fecha-mobile">21 de noviembre del 2025 a las 2:18</span>
                    </time>
                    <button type="button"
                        @click="exportExcel()"
                        :disabled="isExporting"
