<!-- Modal de Confirmación de Eliminación de Item del Ticket -->
<div x-show="isDeleteItemModal" 
     x-cloak
    ...
    <div x-show="isDeleteItemModal"
        ...
        <!-- Botón cerrar -->
        <button @click="isDeleteItemModal = false; setTimeout(() => { itemToDelete = null; }, 200);"
        ...
        <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="space-y-3 sm:space-y-3">
                    ...
                    <div>
                        <p class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-1 break-words"
                            x-text="itemToDelete ? itemToDelete.nombre : ''"></p>
                    </div>

                    <!-- Información del Producto -->
                    <div class="space-y-2.5 sm:space-y-3">
                        <div class="flex items-center justify-between">
                            <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">Código:</span>
                            <span class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white text-right break-words font-mono"
                                x-text="itemToDelete ? itemToDelete.codigo : ''"></span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">Cantidad:</span>
                            <span class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white text-right"
                                x-text="itemToDelete ? itemToDelete.cantidad : ''"></span>
                        </div>

                        <div class="flex items-center justify-between">
                            <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">Precio Unit.:</span>
                            <span class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white text-right"
                                x-text="itemToDelete ? 'S/ ' + itemToDelete.precio.toFixed(2) : ''"></span>
                        </div>
                        ...
                        <div class="pt-2 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-base sm:text-lg font-bold text-gray-900 dark:text-white"
                                    x-text="itemToDelete ? 'S/ ' + itemToDelete.subtotal.toFixed(2) : ''"></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-4 sm:mt-6">
                <button @click="confirmDeleteItem()" type="button"
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-2.5">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold text-gray-900 dark:text-white text-right break-words font-mono"
                                x-text="itemToDelete ? itemToDelete.codigo : ''"></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Precio Unit.:</span>
                            <span class="text-sm font-semibold text-gray-900 dark:text-white text-right"
                                x-text="itemToDelete ? 'S/ ' + itemToDelete.precio.toFixed(2) : ''"></span>
                        </div>
