...
<div x-show="isDeleteConfirmModal" 
                ...
                <div class="space-y-3 sm:space-y-3">
                    ...
                    <div>
                        <p class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-1 break-words"
                            x-text="itemToDelete ? (itemToDelete.name || 'Cliente') : ''"></p>
                    </div>

                    <!-- Información del Cliente -->
                    <div class="space-y-2.5 sm:space-y-3">
                        <template x-if="itemToDelete && itemToDelete.dni">
                            <div class="flex items-center justify-between">
                                <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">DNI:</span>
                                <span class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white text-right break-words"
                                    x-text="itemToDelete.dni"></span>
                            </div>
                        </template>

                        <template x-if="itemToDelete && itemToDelete.ruc">
                            <div class="flex items-center justify-between">
                                <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">RUC:</span>
                                <span class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white text-right break-words"
                                    x-text="itemToDelete.ruc"></span>
                            </div>
                        </template>

                        <template x-if="itemToDelete && itemToDelete.phone">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-0">
                                ...
                                <span class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white sm:text-right break-words"
                                    x-text="itemToDelete.phone"></span>
                            </div>
                        </template>

                        <template x-if="itemToDelete && itemToDelete.address">
                            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-0">
                                <span class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Dirección:</span>
                                <span class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 sm:text-right sm:max-w-[60%] break-words"
                                    x-text="itemToDelete.address"></span>
                            </div>
                        </template>

                        <template x-if="itemToDelete && itemToDelete.distrito && itemToDelete.provincia">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-0">
                                <span class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Distrito / Provincia:</span>
                                <span class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white sm:text-right break-words"
                                    x-text="(itemToDelete.distrito || '') + ', ' + (itemToDelete.provincia || '')"></span>
                            </div>
                        </template>
                    </div>
                </div>
    ...
    <div x-show="isDeleteConfirmModal"
        ...
        <div x-show="isDeleteConfirmModal"
            ...
            <!-- Información del Cliente a Eliminar Móvil -->
            <div x-show="itemToDelete" class="mb-4">
                <div class="space-y-3">
                    ...
                    <div class="space-y-2.5">
                        ...
                        <template x-if="itemToDelete && itemToDelete.ruc">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-500 dark:text-gray-400">RUC:</span>
                                <span class="text-sm font-semibold text-gray-900 dark:text-white text-right break-words"
                                    x-text="itemToDelete.ruc"></span>
                            </div>
                        </template>
                        ...
                        <template x-if="itemToDelete && itemToDelete.address">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm text-gray-700 dark:text-gray-300 text-right break-words"
                                    x-text="itemToDelete.address"></span>
                            </div>
                        </template>
                        ...
                        <template x-if="itemToDelete && itemToDelete.distrito && itemToDelete.provincia">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Distrito / Provincia:</span>
                                <span class="text-sm font-semibold text-gray-900 dark:text-white text-right break-words"
                                    x-text="(itemToDelete.distrito || '') + ', ' + (itemToDelete.provincia || '')"></span>
                            </div>
                        </template>
