...
@section('content')
    <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li>
                            <a class="font-medium" href="{{ route('customers') }}">Clientes /</a>
                        </li>
            ...
            <!-- ====== Forms Section Start ====== -->
            <div class="rounded-sm border dark:bg-gray-800 border-stroke bg-white shadow-default dark:border-strokedark" x-data="{
                cliente: {
                    tipo_documento: 'dni',
                    documento: '',
                    nombres: '',
                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <div class="hidden w-full xl:block xl:w-1/2">
                        <div class="px-26 py-17.5 text-center">
                            <a class="mb-5.5 inline-flex items-center" href="{{ route('home') }}">
                                ...
                                <img class="hidden dark:block h-10" src="{{ asset('images/logo/nexos-logo-w.png') }}" alt="Logo" />
                                <!-- Logo para modo claro -->
                                <img class="dark:hidden h-10" src="{{ asset('images/logo/nexos-logo-w.png') }}" alt="Logo" />
                            </a>

                            <p class="font-medium 2xl:px-20">
                                Actualice la información del cliente para mantener sus datos actualizados en el sistema.
                            </p>
                    ...
                    <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="flex flex-col md:flex-row gap-0">
                                            ...
                                            <div class="flex w-full md:flex-row border-[0.5px] border-gray-300 dark:border-gray-600 rounded-lg md:rounded overflow-hidden focus-within:ring-2 md:focus-within:ring-1 focus-within:ring-blue-500 dark:focus-within:ring-blue-400">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       :placeholder="cliente.tipo_documento === 'ruc' ? 'Ingrese RUC' : 'Ingrese DNI'">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               placeholder="Nombres">
                                        <input type="text" 
                                               x-model="cliente.razon_social"
                                               x-show="cliente.tipo_documento === 'ruc'"
                                               x-cloak
                                               style="appearance: none; -webkit-appearance: none; -moz-appearance: textfield;"
                                               class="w-full text-sm font-mono text-black dark:text-white bg-white dark:bg-gray-800 md:bg-transparent border-[0.5px] border-gray-300 dark:border-gray-600 rounded-lg md:rounded px-3 md:px-2 py-2 md:py-2.5 focus:outline-none focus:ring-2 md:focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 placeholder:text-gray-400 placeholder:opacity-60 dark:placeholder:text-gray-500 dark:placeholder:opacity-60"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="flex w-full border-[0.5px] border-gray-300 dark:border-gray-600 rounded-lg md:rounded overflow-hidden focus-within:ring-2 md:focus-within:ring-1 focus-within:ring-blue-500 dark:focus-within:ring-blue-400">
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Dirección</label>
                                        <input type="text" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Distrito</label>
                                        <input type="text" 
                                               x-model="cliente.distrito"
                                               style="appearance: none; -webkit-appearance: none; -moz-appearance: textfield;"
                                               class="w-full text-sm text-gray-900 dark:text-white bg-white dark:bg-gray-800 md:bg-transparent border-[0.5px] border-gray-300 dark:border-gray-600 rounded-lg md:rounded px-3 md:px-2 py-2 md:py-2.5 focus:outline-none focus:ring-2 md:focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 placeholder:text-gray-400 placeholder:opacity-60 dark:placeholder:text-gray-500 dark:placeholder:opacity-60"
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">Provincia</label>
                                        <input type="text" 
                                               x-model="cliente.provincia"
                                               style="appearance: none; -webkit-appearance: none; -moz-appearance: textfield;"
                                               class="w-full text-sm text-gray-900 dark:text-white bg-white dark:bg-gray-800 md:bg-transparent border-[0.5px] border-gray-300 dark:border-gray-600 rounded-lg md:rounded px-3 md:px-2 py-2 md:py-2.5 focus:outline-none focus:ring-2 md:focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-400 placeholder:text-gray-400 placeholder:opacity-60 dark:placeholder:text-gray-500 dark:placeholder:opacity-60"
                            ...
                            <div class="mt-8 mb-5">
                                <button type="submit"
                                        class="w-full cursor-pointer rounded-lg border border-primary bg-primary p-2.5 font-medium text-white transition hover:bg-opacity-90">
                                    Actualizar cliente
                                </button>
                            </div>
                            <div>
