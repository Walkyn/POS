...
<div x-data="{
                                         ...
                                         class="absolute z-50 mt-2 w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-3">
                                            ...
                                            <template x-for="categoria in categorias" :key="categoria">
                                                <button @click.stop="toggleCategoria(categoria)"
                                                        ...
                                                        :class="{ 'bg-blue-50 dark:bg-blue-900/20': producto.categoria ===
                                                                categoria }">
                            ...
                            <tbody>
                                <template x-for="lote in lotes" :key="lote.id">
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" 
                                            :class="{ 'bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500': editingLoteId ===
                                                    lote.id }">
    ...
    <div x-show="isValidationLoteModal" x-cloak
            ...
            <div
                class="no-scrollbar relative w-full max-w-[450px] overflow-hidden rounded-2xl sm:rounded-3xl bg-white shadow-2xl dark:bg-gray-900">
                ...
                <div class="p-4 sm:p-6 lg:p-8">
                    <div class="mb-4 sm:mb-6 flex items-start gap-3 sm:gap-4">
                        <div
                            ...
                            <svg class="h-6 w-6 sm:h-8 sm:w-8 text-yellow-600 dark:text-yellow-400" fill="none"
                    ...
                    <div class="mb-4 sm:mb-6">
                        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-300">
                            Por favor ingresa una <strong class="text-gray-900 dark:text-white">cantidad válida</strong>
                            mayor a cero para poder guardar el lote.
                        </p>
                                </div>
                    ...
                    <div x-show="loteToValidate" class="mb-4 sm:mb-4">
                        <div class="space-y-3 sm:space-y-3">
                            <div
                                class="group relative bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-2.5 sm:p-3">
                                <div class="flex items-start gap-2 sm:gap-3">
                                    <div
                                        class="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                                    ...
                                    <div class="flex-1 min-w-0 space-y-1.5">
                                        <div class="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                                            <span
                                                class="text-xs sm:text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Lote</span>
                                            <span
                                                class="text-sm sm:text-base font-bold text-gray-900 dark:text-white font-mono break-all"
                                        ...
                                        <div class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            <span class="ml-1"
                                                x-text="loteToValidate ? (loteToValidate.cantidad !== null && loteToValidate.cantidad !== undefined ? loteToValidate.cantidad : 'No definida') : 'No definida'"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mb-4 sm:mb-6 flex items-start gap-3 sm:gap-4">
                    <div
                        class="flex h-12 w-12 sm:h-14 sm:w-14 flex-shrink-0 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/30">
                            <svg class="h-6 w-6 sm:h-8 sm:w-8 text-red-600 dark:text-red-400" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z">
                            </path>
                                ...
                                <div class="flex-1 min-w-0 space-y-1.5">
                                    ...
                                    <div class="grid grid-cols-2 gap-1.5 sm:gap-2">
                                        <div class="flex items-center gap-1 sm:gap-1.5">
                                                <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 dark:text-gray-500 flex-shrink-0"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                ...
                                                <span
                                                    class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Cantidad:</span>
                                                <span
                                        ...
                                        <div class="flex items-center gap-1 sm:gap-1.5">
                                                ...
                                                <span
                                                    class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Vence:</span>
                                                <span
                                                    class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white break-words"
                                        ...
                                        <div
                                            class="grid grid-cols-3 gap-1.5 sm:gap-2 pt-2 border-t border-gray-200 dark:border-gray-600">
                                        ...
                                        <template x-if="loteToDelete && loteToDelete.precio_mayoreo !== undefined">
                                            <div class="flex flex-col">
                                                    <span class="text-xs text-gray-500 dark:text-gray-400">P.
                                                        Mayoreo</span>
                                                    <span
                                                        class="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white"
