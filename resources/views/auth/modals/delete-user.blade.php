...
<div x-show="isDeleteConfirmModal" 
                ...
                <div class="space-y-3 sm:space-y-3">
                    ...
                    <div>
                        <p class="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-1 break-words"
                            x-text="itemToDelete ? (itemToDelete.name || 'Usuario') : ''"></p>
                    </div>
                    ...
                    <div class="space-y-2.5 sm:space-y-3">
                        <template x-if="itemToDelete && itemToDelete.email">
                            <div class="flex items-center justify-between">
                                <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">Email:</span>
                        ...
                        <template x-if="itemToDelete && itemToDelete.rol">
                            <div class="flex items-center justify-between">
                                <span class="text-sm sm:text-base font-medium text-gray-500 dark:text-gray-400">Rol:</span>
                                <span class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white text-right break-words"
                                    x-text="itemToDelete.rol"></span>
                            </div>
                        </template>
                    </div>
                </div>
    ...
    <div x-show="isDeleteConfirmModal"
        ...
        <div class="flex justify-center pt-3 pb-2 py-4">
            <div class="w-12 h-1 bg-gray-300 dark:bg-gray-600 rounded-full cursor-pointer" @click.stop="isDeleteConfirmModal = false; setTimeout(() => { itemToDelete = null; }, 200);"></div>
        </div>
        ...
        <div x-show="isDeleteConfirmModal"
            ...
            <!-- Información del Usuario a Eliminar Móvil -->
