            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                ...
                <div
                    ...
                    <div class="mt-4 flex items-end justify-between">
                        <div>
                            <h4 class="text-title-md font-bold text-black dark:text-white font-numbers">
                                $3.456K
                            </h4>
                            <span class="text-sm font-medium">Total ventas</span>
                        </div>

                        <span class="flex items-center gap-1 text-sm font-medium text-meta-3 font-numbers">
                            0.43%
                ...
                <div
                    ...
                    <div class="mt-4 flex items-end justify-between">
                        <div>
                            ...
                            <span class="text-sm font-medium">Total productos</span>
                        </div>
                ...
                <div
                    ...
                    <div class="mt-4 flex items-end justify-between">
                        <div>
                            ...
                            <span class="text-sm font-medium">Total usuarios</span>
                        </div>

                        <span class="flex items-center gap-1 text-sm font-medium text-meta-5 font-numbers">
                            0.95%
                    ...
                    <div>
                        <a href="messages.html"
                            ...
                            <div class="flex flex-1 items-center justify-between">
                                ...
                                <div class="flex h-6 w-6 items-center justify-center rounded-full bg-primary">
                                    <span class="text-sm font-medium text-white font-numbers">3</span>
                                </div>
                            </div>
                        </a>
                        <a href="messages.html"
                        ...
                        <a href="messages.html"
                            ...
                            <div class="flex flex-1 items-center justify-between">
                                ...
                                <div class="flex h-6 w-6 items-center justify-center rounded-full bg-primary">
                                    <span class="text-sm font-medium text-white font-numbers">2</span>
                                </div>
                            </div>
                        </a>
                        <a href="messages.html"
