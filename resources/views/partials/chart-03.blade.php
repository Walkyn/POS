    ...
    <div>
      <div class="relative z-20 inline-block">
        <select
          name=""
          id=""
          class="relative z-20 inline-flex appearance-none rounded-lg border border-stroke bg-white py-1.5 pl-3 pr-8 text-sm font-medium text-black outline-none transition-all hover:border-primary focus:border-primary focus:ring-0 dark:border-strokedark dark:bg-boxdark dark:text-white dark:hover:border-primary dark:focus:border-primary"
        >
