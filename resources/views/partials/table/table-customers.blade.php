<main class="h-full pb-16 overflow-y-auto" x-data="{ 
    ...
    <div>
                    ...
                    <div
                        ...
                        <div class="w-full md:flex-1 order-2 md:order-1 mt-4 md:mt-0">
                            <form class="flex items-center" id="searchForm">
                                <label for="simple-search" class="sr-only">Buscar cliente</label>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 hidden md:table">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="p-4">Distrito / Provincia</th>
                                    <th scope="col" class="p-4">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 customer-row" 
                                        data-customer-id="1">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                            <div class="h-12 w-12 rounded-full overflow-hidden flex-shrink-0 border-2 border-gray-200 dark:border-gray-700">
                                                <img :src="getAvatarUrl('Juan Martínez')" alt="Juan Martínez" class="h-full w-full object-cover" />
                                            </div>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <span class="block text-sm text-gray-600 dark:text-gray-400">+51 987 654 321</span>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                                        <div class="flex items-center gap-1.5">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-400">Lima, Lima</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <button type="button" 
                                                @click.stop="itemToDelete = { name: 'Juan Martínez', phone: '+51 987 654 321', address: 'Av. Principal 123', distrito: 'Lima', provincia: 'Lima', dni: '12345678' }; isDeleteConfirmModal = true;"
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 customer-row" 
                                    ...
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                            <div class="h-12 w-12 rounded-full overflow-hidden flex-shrink-0 border-2 border-gray-200 dark:border-gray-700">
                                                <img :src="getAvatarUrl('María López')" alt="María López" class="h-full w-full object-cover" />
                                            </div>
                                            <div class="flex flex-col flex-1 min-w-0">
                                                <div class="mb-1">
                                                    <span class="text-base font-semibold text-black dark:text-white block">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <span class="block text-sm text-gray-600 dark:text-gray-400">+51 987 123 456</span>
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400 max-w-xs">
                                        <span class="break-words block">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                                        <div class="flex items-center gap-1.5">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-400">Yanahuara, Arequipa</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('customers.edit', 2) }}" 
                                               title="Editar"
                                               class="flex items-center justify-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                            ...
                                            <button type="button" 
                                                @click.stop="itemToDelete = { name: 'María López', phone: '+51 987 123 456', address: 'Calle Los Olivos 456', distrito: 'Yanahuara', provincia: 'Arequipa', dni: '87654321' }; isDeleteConfirmModal = true;"
                                                class="flex items-center justify-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded text-sm p-2 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="h-4 w-4" viewBox="0 0 20 20"
                                                    fill="currentColor">
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 customer-row" 
                                    ...
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                            <div class="h-12 w-12 rounded-full overflow-hidden flex-shrink-0 border-2 border-gray-200 dark:border-gray-700">
                                                <img :src="getAvatarUrl('Tech Solutions SAC')" alt="Tech Solutions SAC" class="h-full w-full object-cover" />
                                            </div>
                                            <div class="flex flex-col flex-1 min-w-0">
                                                <div class="mb-1">
                                                    <span class="text-base font-semibold text-black dark:text-white block">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <span class="block text-sm text-gray-600 dark:text-gray-400">+51 987 555 789</span>
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400 max-w-xs">
                                        <span class="break-words block">
                                            Av. Tecnológica 789
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                                        <div class="flex items-center gap-1.5">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-400">San Isidro, Lima</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('customers.edit', 3) }}" 
                                               title="Editar"
                                               class="flex items-center justify-center text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                                    <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                            ...
                                            <button type="button" 
                                                @click.stop="itemToDelete = { name: 'Tech Solutions SAC', phone: '+51 987 555 789', address: 'Av. Tecnológica 789', distrito: 'San Isidro', provincia: 'Lima', ruc: '20531320574' }; isDeleteConfirmModal = true;"
                                                class="flex items-center justify-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded text-sm p-2 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="h-4 w-4" viewBox="0 0 20 20"
                                                    fill="currentColor">
                        ...
                        <div class="md:hidden space-y-4 px-4 pt-0 pb-4">
                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                                ...
                                <div class="grid grid-cols-1 gap-3 mb-4">
                                    <div>
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">+51 987 654 321</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Distrito / Provincia</p>
                                        <div class="flex items-center gap-1.5">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400 dark:text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" title="Eliminar" @click="itemToDelete = { name: 'Juan Martínez', phone: '+51 987 654 321', address: 'Av. Principal 123', distrito: 'Lima', provincia: 'Lima', dni: '12345678' }; isDeleteConfirmModal = true;" class="flex-1 flex items-center justify-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                                ...
                                <div class="grid grid-cols-1 gap-3 mb-4">
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Teléfono</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">+51 987 123 456</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Dirección</p>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" title="Eliminar" @click="itemToDelete = { name: 'María López', phone: '+51 987 123 456', address: 'Calle Los Olivos 456', distrito: 'Yanahuara', provincia: 'Arequipa', dni: '87654321' }; isDeleteConfirmModal = true;" class="flex-1 flex items-center justify-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                        </svg>
                                    </button>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                                ...
                                <div class="grid grid-cols-1 gap-3 mb-4">
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Teléfono</p>
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">+51 987 555 789</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Dirección</p>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" title="Eliminar" @click="itemToDelete = { name: 'Tech Solutions SAC', phone: '+51 987 555 789', address: 'Av. Tecnológica 789', distrito: 'San Isidro', provincia: 'Lima', ruc: '20531320574' }; isDeleteConfirmModal = true;" class="flex-1 flex items-center justify-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                        </svg>
                                    </button>
        ...
        @include('customers.modals.delete-customer')
