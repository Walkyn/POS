    ...
    <div class="hidden sm:flex sm:flex-1 sm:justify-center">
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <div class="flex items-center justify-center">
          <span class="text-sm font-bold text-black dark:text-white uppercase text-center" id="current-date" style="font-family: 'Nunito Sans', -apple-system, BlinkMacSystemFont, sans-serif;">
            {{ \Carbon\Carbon::now()->locale('es')->isoFormat('DD [DE] MMMM [DEL] YYYY') }}
          </span>
        </div>
        <!-- Hora -->
        <div class="flex items-center justify-center">
        ...
        >
          ...
          >
            <div class="px-4.5 py-3">
              <h5 class="text-sm font-medium text-bodydark2">Notificaciones</h5>
            </div>
                ...
                >
                  <p class="text-sm">
                    <span class="text-black dark:text-white"
                      >Editar su información en un swipe</span
                    >
                    El usuario ha editado su información en un swipe.
                  </p>

                  <p class="text-xs">12 de mayo de 2025</p>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <p class="text-sm">
                    <span class="text-black dark:text-white"
                      >El usuario ha creado un nuevo swipe</span
                    >
                    El usuario ha creado un nuevo swipe.
                  </p>

                  <p class="text-xs">24 de febrero de 2025</p>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <p class="text-sm">
                    <span class="text-black dark:text-white"
                      >El usuario ha eliminado un swipe</span
                    >
                    El usuario ha eliminado un swipe.
                  </p>

                  <p class="text-xs">04 de enero de 2025</p>
                </a>
              </li>
              <li>
                <a
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    ...
                    <p class="text-xs">2 minutos atrás</p>
                  </div>
                </a>
              </li>
              <li>
                ...
                >
                  ...
                  <div>
                    ...
                    <p class="text-sm">¿Puedo compartir tu oferta?</p>
                    <p class="text-xs">10 minutos atrás</p>
                  </div>
                </a>
              </li>
              <li>
        ...
        >
          <span class="hidden text-right lg:block">
            <span class="block text-sm font-medium text-black dark:text-white"
              >Brayan Capa M</span
            >
            <span class="block text-xs font-medium">Desarrollador</span>
          </span>
